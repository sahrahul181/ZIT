...
pub const Inst = union(enum) {
    ...
    /// Resolve a const-string index to a heap String object via runtime.gcNewString.
    new_string: struct { dest: Operand, str_idx: u32 },
    ...
    pub fn format(self: Inst, writer: *std.Io.Writer) !void {
        switch (self) {
            .monitor_enter => |v| {
                try writer.writeAll("MONITOR_ENTER ");
                try v.src.format(writer);
            },
            .monitor_exit => |v| {
                try writer.writeAll("MONITOR_EXIT ");
                try v.src.format(writer);
            },
            .mov => |v| {
                try writer.writeAll("MOV ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .add => |v| {
            ...
            .idiv => |v| {
                ...
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.rem.format(writer);
                try writer.writeAll(" <- ");
                try v.src.format(writer);
            },
            .irem => |v| {
                try writer.writeAll("IREM ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.rem.format(writer);
                try writer.writeAll(" <- ");
            ...
            .movsxd => |v| {
                try writer.writeAll("MOVSXD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .movsx8 => |v| {
                try writer.writeAll("MOVSX8 ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .movsx16 => |v| {
                try writer.writeAll("MOVSX16 ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .movzx16 => |v| {
                try writer.writeAll("MOVZX16 ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .cvtsi2ss => |v| {
                try writer.writeAll("CVTSI2SS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            ...
            .cvtss2sd => |v| {
                try writer.writeAll("CVTSS2SD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .cvtsd2ss => |v| {
                try writer.writeAll("CVTSD2SS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .negss => |v| {
                try writer.writeAll("NEGSS ");
                try v.dest.format(writer);
            },
            .negsd => |v| {
                try writer.writeAll("NEGSD ");
                try v.dest.format(writer);
            },
            .frem32 => |v| {
                try writer.writeAll("FREM32 ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .frem64 => |v| {
                try writer.writeAll("FREM64 ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .cmp3 => |v| {
                try writer.print("CMP3.{s} ", .{@tagName(v.kind)});
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.left.format(writer);
                try writer.writeAll(", ");
                try v.right.format(writer);
            },
            .and_op => |v| {
            ...
            .xor_op => |v| {
                try writer.writeAll("XOR ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .shl => |v| {
                try writer.writeAll("SHL ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .shr => |v| {
                try writer.writeAll("SAR ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .ushr => |v| {
                try writer.writeAll("SHR ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            ...
            .addss => |v| {
                try writer.writeAll("ADDSS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .subss => |v| {
                try writer.writeAll("SUBSS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .mulss => |v| {
                try writer.writeAll("MULSS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .divss => |v| {
                try writer.writeAll("DIVSS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .movss => |v| {
                try writer.writeAll("MOVSS ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            ...
            .addsd => |v| {
                try writer.writeAll("ADDSD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .subsd => |v| {
                try writer.writeAll("SUBSD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .mulsd => |v| {
                try writer.writeAll("MULSD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            .divsd => |v| {
                try writer.writeAll("DIVSD ");
                try v.dest.format(writer);
                try writer.writeAll(", ");
                try v.src.format(writer);
            },
            ...
            .alloc_obj => |v| {
                try v.dest.format(writer);
                try writer.print(" = NEW type[{d}]", .{v.type_idx});
            },
            .alloc_arr => |v| {
                try v.dest.format(writer);
                try writer.writeAll(" = NEWARR[");
                try v.size.format(writer);
                try writer.print("] type[{d}]", .{v.type_idx});
            },
            .new_string => |v| {
                try v.dest.format(writer);
                try writer.print(" = NEWSTR string[{d}]", .{v.str_idx});
            },
            .filled_new_array => |v| {
                try v.dest.format(writer);
                try writer.print(" = FILLED_NEWARR type[{d}]", .{v.type_idx});
            },
            .instance_of => |v| {
                try v.dest.format(writer);
                try writer.writeAll(" = INSTANCEOF ");
                try v.obj.format(writer);
                try writer.print(" type[{d}]", .{v.type_idx});
            },
            .fill_array_data => |v| {
                try writer.writeAll("FILL_ARRAY_DATA ");
                try v.array.format(writer);
                try writer.print(" ptr=0x{x} len={d} width={d}", .{ v.data_ptr, v.data_len, v.elem_width });
            },
            .move_exception => |v| {
                try v.dest.format(writer);
                try writer.writeAll(" = MOVE_EXCEPTION");
            },
            .field_load => |v| {
                try v.dest.format(writer);
                try writer.print(" = FLOAD field[{d}]", .{v.field_idx});
                if (v.obj) |o| {
            ...
            .arr_load => |v| {
                try v.dest.format(writer);
                try writer.writeAll(" = ALOAD [");
                try v.array.format(writer);
                try writer.writeAll("][");
                try v.index.format(writer);
                try writer.writeAll("]");
            },
            .arr_store => |v| {
                try writer.writeAll("ASTORE [");
                try v.array.format(writer);
                try writer.writeAll("][");
                try v.index.format(writer);
                try writer.writeAll("] = ");
            ...
            .bounds_check => |v| {
                try writer.writeAll("BOUNDS_CHECK idx=");
                try v.index.format(writer);
